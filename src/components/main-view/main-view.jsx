...
import { Col, Row, FormControl, Dropdown, ButtonGroup } from "react-bootstrap";
...
export const MainView = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://movieflix-87lf.onrender.com/movies", {
      ...
      .then((data) => {
        ...
        setFilteredMovies(moviesFromApi); // Initialize filtered movies with all movies
      })
      .catch((error) => {
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        {/* Routes for login, signup, movie details, and profile view */}
        <Route
          path="/"
          element={
            user ? (
